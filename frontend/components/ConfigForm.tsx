      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="form-group">
          <label className="flex items-center gap-3 text-muted-foreground text-sm font-semibold uppercase tracking-wide mb-2">
            <input
              type="checkbox"
              name="enable_dev_override"
              checked={!!formData.enable_dev_override}
              onChange={handleInputChange}
              className="h-4 w-4"
            />
            Include dev-friendly docker-compose.override.yml
          </label>
          <p className="text-muted-foreground text-sm mt-1 font-mono">
            Enables handy local tweaks like different Studio port, mounted volumes for functions and storage, and verbose PostgREST logs.
          </p>
        </div>
